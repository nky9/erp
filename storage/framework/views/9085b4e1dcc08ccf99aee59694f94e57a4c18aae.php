        ...
        <div class="col-sm-12 col-md-10 col-xxl-8">
            <div class="card mt-5">
                <div class="card-body">
                                ...
                                <ul class="list-group sortable">
                                    <?php $__currentLoopData = $bugStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bug): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-group-item" data-id="<?php echo e($bug->id); ?>">
                                            <span class="text-sm text-dark"><?php echo e($bug->title); ?></span>
                    ...
                    <p class="text-muted mt-4"><strong><?php echo e(__('Note')); ?> : </strong><?php echo e(__('You can easily change order of project Bug status using drag & drop.')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/newtestsoftwares/public_html/erp3_ERPGPSAAS/resources/views/bugstatus/index.blade.php ENDPATH**/ ?>