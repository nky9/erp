                ...
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-4b3dcb8a="" class="d" style="width:710px;margin-left: auto;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid <?php echo e($color); ?>;">
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2"><h1 data-v-4b3dcb8a="" class="fancy-title mb5"><?php echo e(__('PROPOSAL')); ?></h1></div>
                                    <div data-v-4b3dcb8a="" class="col-2 text-right">
                                        <img data-v-4b3dcb8a="" src="<?php echo e($img); ?>" class="d-logo" style="max-width: 250px"></div>
                                </div>
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-1">
                                        ...
                                        <p data-v-4b3dcb8a=""><?php if($settings['company_city']): ?> <?php echo e($settings['company_city']); ?>, <?php endif; ?>
                                            <?php if($settings['company_state']): ?><?php echo e($settings['company_state']); ?><?php endif; ?>
                                            </p>
                                        <p data-v-4b3dcb8a=""><?php if($settings['company_country']): ?> <?php echo e($settings['company_country']); ?><?php endif; ?>
                                ...
                                <hr data-v-4b3dcb8a="" style="border-top: 1px solid <?php echo e($color); ?>;">
                                <div data-v-4b3dcb8a="" class="break-25"></div>
                                <div data-v-4b3dcb8a="" class="row">
...
<?php /**PATH /home/newtestsoftwares/public_html/erp3_ERPGPSAAS/resources/views/proposal/templates/template6.blade.php ENDPATH**/ ?>