                            ...
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-33">
                                        ...
                                        <h1 data-v-b8f60a0c="" class="fancy-title tu mb5" style="color: <?php echo e($color); ?>; border-top: 15px solid <?php echo e($color); ?>;"><?php echo e(__('PROPOSAL')); ?></h1>
                                        <div>
                                            <?php echo DNS2D::getBarcodeHTML( route('proposal.link.copy',Crypt::encrypt($proposal->proposal_id)), "QRCODE",2,2); ?>                                        </div></div>
                                    <div data-v-b8f60a0c="" class="col-33"></div>
                                    <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c="" style="max-width: 250px;" class="d-logo" src="<?php echo e($img); ?>"></div>
                                </div>

                                <div data-v-b8f60a0c="" class="row">
                                    <div data-v-b8f60a0c="" class="col-66"><strong data-v-b8f60a0c="" class="tu mb5" style="color: <?php echo e($color); ?>;"><?php echo e(__('From')); ?>:</strong>
                                        <p data-v-b8f60a0c=""><?php if($settings['company_name']): ?><?php echo e($settings['company_name']); ?><?php endif; ?></p>
                                        ...
                                        <pre data-v-b8f60a0c=""><?php if($settings['company_address']): ?><?php echo e($settings['company_address']); ?><?php endif; ?></pre>
                                        <?php if($settings['company_telephone']): ?><?php echo e($settings['company_telephone']); ?><?php endif; ?>
                                        <p data-v-b8f60a0c=""><?php if($settings['company_city']): ?> <?php echo e($settings['company_city']); ?>, <?php endif; ?>
                                            <?php if($settings['company_state']): ?><?php echo e($settings['company_state']); ?><?php endif; ?>
                                            </p>
                                        <p data-v-b8f60a0c=""><?php if($settings['company_country']): ?> <?php echo e($settings['company_country']); ?><?php endif; ?>
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right"><?php echo e(Utility::proposalNumberFormat($settings,$proposal->proposal_id)); ?></td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: <?php echo e($color); ?>;"><?php echo e(__('Issue Date')); ?>:</td>
                                                <td data-v-363339a0="" class="text-right"><?php echo e(Utility::dateFormat($settings,$proposal->issue_date)); ?></td>
                                            </tr>
                                            <?php if(!empty($customFields) && count($proposal->customField)>0): ?>
                                                <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr data-v-363339a0="">
                                                        <td data-v-363339a0="" class="tu fwb" style="color: <?php echo e($color); ?>;"><?php echo e($field->name); ?>:</td>
                                                        <td data-v-363339a0="" class="text-right"> <?php echo e(!empty($proposal->customField)?$proposal->customField[$field->id]:'-'); ?></td>
                                                    </tr>
...
<?php /**PATH /home/newtestsoftwares/public_html/erp3_ERPGPSAAS/resources/views/proposal/templates/template10.blade.php ENDPATH**/ ?>